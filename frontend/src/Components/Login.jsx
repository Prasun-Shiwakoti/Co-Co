  ...
  return (
    <div className="bg-sky-50 h-[100vh] w-[100vw] flex items-center justify-center">
      <div className="bg-sky-50 p-10 rounded-md shadow-md w-[500px]">
        ...
        <h1 className="font-bold text-center mb-5 text-blue-900 text-4xl">
          Login
        </h1>
        <form className="space-y-4 flex flex-col gap-3">
          ...
          <button
            ...
            className={`bg-blue-600 w-full py-3 mt-10 rounded-full text-white hover:shadow-xl hover:shadow-blue-100 cursor-pointer ${
              loading ? "bg-blue-600" : "bg-blue-200d"
            }`}
            disabled={loading}
          >
            Submit
